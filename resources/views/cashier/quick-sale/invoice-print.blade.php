...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .invoice-wrapper { border: none; max-width: 100%; width: 100%; padding: 0; }
        }
    </style>
</head>
<body>
@php
    ...
    $accountantName = optional(optional($sale)->accountant)->name ?? 'غير محدد';
...
<div class="invoice-wrapper">
    <div class="header-section">
        <div class="store-info">
            ...
            <div class="store-details">
                ...
                <p>السجل التجاري: {{ $store->commercial_registration ?? $store->commercial_register ?? 'غير مسجل' }}</p>
    ...
    <div class="bank-info-footer">
        {{ $store->bank_accounts_info ?? 'مصرف الراجحي: SA0000000000000000000000 | البنك الأهلي: SA0000000000000000000000' }}
    </div>

    <div style="margin-top: 20px; text-align: center; font-size: 11px; color: #94a3b8; border-top: 1px solid #f1f5f9; padding-top: 10px;">
        طريقة الدفع: {{ $saleTypeLabel }} | المحاسب: {{ $accountantName }}
    </div>
</div>
